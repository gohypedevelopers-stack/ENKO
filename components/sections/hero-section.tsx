export function HeroSection() {
  return (
    <section className="grid-paper border-b border-forge/10">
      <div className="container-shell grid min-h-[calc(100vh-73px)] gap-10 py-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:py-16">
        <div>
          <p className="label-kicker mb-4 text-forge/45">India built EV infrastructure</p>
          <h1 className="max-w-2xl text-5xl font-black uppercase leading-[0.92] md:text-7xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a href="/procurement" className="industrial-button bg-warm text-forge">
              Request a Quote
            </a>
          </div>
        </div>
        <div className="relative mx-auto aspect-[0.92] w-full max-w-[440px] border border-forge/25 bg-forge p-3 shadow-soft">
          <div className="absolute -top-6 right-0 label-kicker text-forge/38">Phase signal 05.9</div>
          <div className="h-full border border-white/70 bg-[linear-gradient(180deg,rgba(238,235,228,0.22),rgba(8,8,8,0)_34%),linear-gradient(120deg,#786c59_0%,#151513_55%,#080808_100%)]">
