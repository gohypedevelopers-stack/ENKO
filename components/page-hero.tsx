...
export function PageHero({ title, description, kicker }: PageHeroProps) {
  return (
    <section className="border-b border-forge/10 bg-forge text-white overflow-hidden relative">
      ...
      <div className="container-shell relative z-10 py-20 lg:py-32">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-base md:text-lg leading-7 text-white/70 max-w-xl">
            {description}
          </p>
        </div>
      </div>
